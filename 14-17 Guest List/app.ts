let GuestList:string[] = ["Shamu","sara khan","Sadif"];
...
let MissingGuest = "Sadif"; //The guest is not there
let newguest = "Dr.saima"; //new guest to add to the list
GuestList.pop();
...
// }
console.log(`${MissingGuest} is not in the party.`); 
...
console.log(` ${removeList},sorry you can't come to the dinner party\n`);
}
for(let i=0;i<GuestList.length;i++){
